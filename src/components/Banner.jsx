...
const Banner = () => {
    return (
        <div className='rounded-lg overflow-hidden bg-fixed bg-contain md:bg-cover h-[calc(100vh-100px)] flex items-center' style={{ backgroundImage: `url(${bg})` }}>
            <div className="mx-auto rounded-lg overflow-hidden h-fit flex flex-col justify-center p-3 lg:p-5 md:w-1/2 space-y-3 glass" data-aos="slide-down">
                ...
                <TypeAnimation
                    ...
                    repeat={Infinity}
                    speed={5}
                    className='text-xl md:text-2xl font-pacifico text-end' />
                <Link to='/login' className="btn btn-outline btn-sm md:btn-md flex gap-0 w-fit mx-auto">
